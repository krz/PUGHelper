...
{\*\expandedcolortbl;;}
\paperw11900\paperh16840\margl1440\margr1440\vieww15580\viewh11020\viewkind0
\pard\tx720\tx1440\tx2160\tx2880\tx3600\tx4320\tx5040\tx5760\tx6480\tx7200\tx7920\tx8640\pardirnatural\partightenfactor0

\f0\fs24 \cf0 -- Create a frame to register events\
...
local function ShowEditableTextBox(defaultText)\
   ...
   editFrame:Show()\
   \
   -- Optional: Hide the frame after 30 seconds\
...
local function OnEvent(self, event, ...)\
   if event == "PLAYER_TARGET_CHANGED" then\
      ...
      if npcMessages[npcID] then\
         -- Show the editable text box with the message for the NPC\
